...
<div id="pagination">
    <ul class="toggle report-list-toggle">
        <li class="active"><a href="#rb_list-view" class="pagination_list"><?php echo Kohana::lang('ui_main.list'); ?></a></li>
        <li><a href="#rb_map-view" class="pagination_map"><?php echo Kohana::lang('ui_main.map'); ?></a></li>
        <li><a href="#rb_gallery-view" class="pagination_gallery">Gallery</a></li>
    </ul>
